...
import { oneDoctor, updateDoctor, updateDoctorPassword } from "actions/doctor";
...
const Doctor = ({ data, query }) => {
  ...
  const { name, email, doctorId, images } = values;
  useEffect(() => {
    setAlert({ ...alert, loading: true });
    let token = getCookie("token_doctor");
    // if (router.isReady) {
    oneDoctor(query.Doctor, token)
      .then((data) => {
        ...
        <form className="block md:grid md:grid-cols-3">
          ...
          <div className="md:col-span-2 m-2">
            ...
            <div className="border-2 border-gray-200 rounded-xl p-2 ">
              ...
              <div className="my-2">
                <label class="text-gray-600 mb-2 block">Doctor Id</label>
                <h2
                  type="text"
                  //   value={doctorId}
