...
const Index = () => {
  ...
  // const { nic, dateOfBirth, appointmentDate2, city } = filters;
  ...
  const handleSubmit = async (e) => {
    ...
    await allPatients(params, token)
      .then((data) => {
        ...
        {show ? (
                ...
                <div className=" m-2">
                  <div className="border-2 border-gray-200 rounded-xl p-2 ">
                    <div className="grid grid-cols-2 gap-2">
                      ...
                      <div className="col-span-1">
                        <label class="text-gray-600 mb-2 block my-2">nic</label>
                        <input
                          type="text"
                          value={nic}
          ...
          <div className=" mr-10 border-2 border-gray-200 rounded-xl">
            <div className="grid grid-cols-5 md:grid-cols-6 bg-gray-600 p-4 rounded-xl text-white text-xl font-sb ">
              ...
              <h2>NIC</h2>
              <h2>Date Of Birth</h2>
              <h2 className="hidden md:block">City</h2>
              {/* <h2>cancel</h2> */}
              <h2>Delete</h2>
            </div>
            <div className="">
