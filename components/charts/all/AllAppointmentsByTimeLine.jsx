...
import { AllAppointmentsCountByTime } from "actions/analytics";
import { Chart as ChartJS } from "chart.js/auto";
import Message from "components/Message";

const AllAppointmentsByTimeLine = () => {
      ...
      .then((data) => {
        if (data.status && data.status == "success") {
          ...
          setBarData({
            ...
            datasets: [
              {
                label: "All Appointments By Time",
                data: dataArray,
...
// AllAppointmentsByTimeLine.getInitialProps = ({ router }) => {
...
export default AllAppointmentsByTimeLine;
